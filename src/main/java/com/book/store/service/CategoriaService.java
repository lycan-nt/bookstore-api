...
import com.book.store.service.exceptions.ObjectNotFoundException;
...
public class CategoriaService {
	...
	public void delete(Integer id) {
		...
		try {
			...
			throw new com.book.store.service.exceptions.DataIntegrityViolationException("Categoria não pode ser deletado! Possui livros associados");
		}
	}
